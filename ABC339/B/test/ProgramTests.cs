...
namespace AtCorder.Tests
{
    ...
    public class ProgramTests
    {
        ...
        private TextReader? m_Defaultinput;
        private TextWriter? m_Defaultoutput;
        ...
        {
            m_input?.BaseStream.Dispose();
            m_input?.DiscardBufferedData();
            m_output?.Flush();

            Console.SetIn(m_Defaultinput);
            Console.SetOut(m_Defaultoutput);
        }
