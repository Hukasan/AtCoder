...
namespace AtCorder
{
    public class Program : ProgramBase
    {
        public static void Main()
        {
            ...
            var A = Line(true).Select(x => x.ToInt());
            var M = Line(true)[0].ToInt();
            var B = Line(true).Select(x => x.ToInt());
            var L = Line(true)[0].ToInt();
            var C = Line(true).Select(x => x.ToInt());
            var Q = Line(true)[0].ToInt();
            var X = Line(true).Select(x => x.ToInt());
